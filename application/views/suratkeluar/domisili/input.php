    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="<?= base_url();?>surat/inputdomisili"><?= $judul;?></a>
                </li>
            </ul>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor" id="nomor" class="form-control" value="145.12/<?= $kode;?>/PR-06/<?= getRomawi(date('m'));?>/<?= date('Y');?>" readonly>
