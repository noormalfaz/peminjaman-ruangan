                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <input type="hidden" name="id" id="id" value="<?= $kepolisian["id_kepolisian"];?>">
                            <div class="form-group">
                                <label for="nomor">Nomor Surat</label>
                                <input type="text" name="nomor" id="nomor" class="form-control" value="<?= $kepolisian["nomor"];?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="dp">Data Penduduk</label>
                                <select name="dp" id="dp" class="form-control">
                                    <?php foreach($data_penduduk as $dp):?>
                                        <?php if($dp["id_data"] == $kepolisian["data_id"]):?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keperluan" id="keperluan" class="form-control" value="<?= $kepolisian["keperluan"];?>" placeholder="Masukan Untuk Keperluan..">
